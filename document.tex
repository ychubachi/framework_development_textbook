...
\newpage
\section{オブジェクト指向らしくないサンプルコード}
最近はあまり見かけないが，一昔前のJava言語の入門書には最初のプログラム
の例として次のようなコードが載っていたものである．
...
\subsection{クラスとインスタンス}
インスタンス生成を用いて書き直すと次の通りになる．
...
\subsection{Square4: 情報を束ねるためのクラス}
カプセル化
