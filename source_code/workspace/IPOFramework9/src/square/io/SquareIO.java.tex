...
\PY{k+kn}{package}\PY{+w}{ }\PY{n}{square}\PY{o}{.}\PY{n+na}{io}\PY{o}{;}
...
\PY{k+kn}{import}\PY{+w}{ }\PY{n+nn}{square.process.SquaredValue}\PY{o}{;}
\PY{k+kn}{import}\PY{+w}{ }\PY{n+nn}{square.process.ValueToBeSquared}\PY{o}{;}
...
\PY{k+kd}{public}\PY{+w}{ }\PY{k+kd}{class}\PY{+w}{ }\PY{n+nc}{SquareIO}\PY{+w}{ }\PY{k+kd}{implements}\PY{+w}{ }\PY{n}{InputAndOutput}\PY{+w}{ }\PY{o}{\PYZob{}}
...
\PY{+w}{    }\PY{+w}{    }\PY{n}{ValueToBeSquared}\PY{+w}{ }\PY{n}{vtbs}\PY{+w}{ }\PY{o}{=}\PY{+w}{ }\PY{o}{(}\PY{n}{ValueToBeSquared}\PY{o}{)}\PY{+w}{ }\PY{n}{input}\PY{o}{;}
...
\PY{+w}{    }\PY{+w}{    }\PY{n}{vtbs}\PY{o}{.}\PY{n+na}{setValue}\PY{o}{(}\PY{n}{Double}\PY{o}{.}\PY{n+na}{parseDouble}\PY{o}{(}\PY{n}{valueString}\PY{o}{)}\PY{o}{)}\PY{o}{;}
\PY{+w}{    }\PY{o}{\PYZcb{}}
...
\PY{+w}{    }\PY{+w}{    }\PY{n}{System}\PY{o}{.}\PY{n+na}{out}\PY{o}{.}\PY{n+na}{println}\PY{o}{(}\PY{l+s}{"計算結果："}\PY{+w}{ }\PY{o}{+}\PY{+w}{ }\PY{n}{sv}\PY{o}{.}\PY{n+na}{getResult}\PY{o}{(}\PY{o}{)}\PY{o}{)}\PY{o}{;}
\PY{+w}{    }\PY{o}{\PYZcb{}}
\PY{o}{\PYZcb{}}
\end{Verbatim}
